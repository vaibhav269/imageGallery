...
export default props => 
    <div className="col-12 text-center">
        <div className = 'button d-inline-block m-2 mr-5 d-inline-block'>
            ...
            <input type='file' accept="image/*" className="d-none" id='single' onChange={props.onChange} /> 
        </div>
        ...
        <div className = 'button d-inline-block m-2 ml-5 d-inline-block'>
            ...
            <input className="d-none" accept="image/*" type='file' id='multi' onChange={props.onChange} multiple  />
        </div>
    </div>